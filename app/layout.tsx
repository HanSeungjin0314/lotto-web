    ...
    <html lang="ko">
      <body>
        <header className="site-header">
          <a href="/" className="brand brand-logo" aria-label="로또스탯픽 홈">
            <img src="/logo.svg" alt="로또스탯픽" />
          </a>
